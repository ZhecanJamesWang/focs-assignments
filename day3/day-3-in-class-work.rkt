...
(define (myFactorial num)
	(if (equal? 0 num) 
		1
		(* (myFactorial (- num 1)) num)
		)
	)
...
(define (tFactorial num left)
	(if (= 0 num) 
		left
		(tFactorial (- num 1) (* left num))
		)
	)
...
(define (myFilter conds obj)
	(cond
		[(null? obj) '()]
   		[(conds (first obj)) (cons (first obj) (myFilter  conds (rest obj)))]
   		[else (myFilter  conds (rest obj))]
   		)
	)

; (myFilter even? '(1 2 3 4 5 6))  ;;--> '(2 4 6)  ;; using the built-in even?

; (myFilter teen '(21 17 2 13 4 42 2 16 3)) ;;--> '(17 13 16)
;                         ;; assuming 
; (myFilter list? '(3 (3 2 1) symbol (4 2) (1 (2) 3))) ;;--> '((3 2 1) (4 2) (1 (2) 3))
...
(define (myMap conds obj)
	(if(null? obj) 
		'()
   		(cons (conds (first obj)) (myMap conds (rest obj))))
	)

; (myMap double '(1 2 3))  ;--> '(4 5 6)  ;; assuming (define (double x) (* 2 x))
; (myMap incr '(1 2 3)) ;--> '(2 3 4)     ;; assuming (define (incr x) (+ x 1))
; (myMap last '((3 2 1) (4 2) (1 2 3))) ;--> '(1 2 3)
...
(define (myAppend list1 list2)
	(if (null? list1) 
		list2
		(cons (first list1) (myAppend (rest list1) list2))
		)
	)
...
(define (myZip list1 list2)
	(cond
		[(null? list1) '()]
		[(null? list2) '()]
		[else (cons (list (first list1) (first list2)) (myZip (rest list1) (rest list2)))]
		)
	)

; (myZip '(1 2 3) '(4 5 6)) ;; --> '((1 4) (2 5) (3 6))
; (myZip '(1 2 3) '(a b c d e f g)) ;; --> '((1 a) (2 b) (3 c))
...
(define (myReverse l)
	(if (null? l)
		'()
		(myAppend (myReverse (rest l)) (list (first l)))
		)
	)
